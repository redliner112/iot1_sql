...
<kendo:menu name="Menu">
    <kendo:menu-items>
        ...
        <kendo:menu-item text="회계관리"></kendo:menu-item>
        <kendo:menu-item text="재무관리"></kendo:menu-item>
        <kendo:menu-item text="마이페이지"></kendo:menu-item>
        <kendo:menu-item text="그룹웨어" ></kendo:menu-item>
    </kendo:menu-items>
</kendo:menu>
</div>
