...
<c:url var="vrcUrl" value="/vendor/create"/>
<c:url var="vrdUrl" value="/vendor/delete" />
<c:url var="vruUrl" value="/vendor/update" />
...
<body>
	...
	<kendo:grid title="회사리스트" name="vendorGrid" height="320px"
		...
		page="onPaging" group="onGrouping" persistSelection="true">
		<kendo:grid-editable mode="incell">
			...
			<kendo:dataSource pageSize="20" batch="true">
				<kendo:dataSource-transport>
					...
					<kendo:dataSource-transport-create url="${vrcUrl}" dataType="json"
						type="POST" contentType="application/json" />
					<kendo:dataSource-transport-destroy url="${vrdUrl}" dataType="json"
						type="POST" contentType="application/json" />
					<kendo:dataSource-transport-update url="${vruUrl}" dataType="json"
						type="POST" contentType="application/json" />
